...
using Resources = YilanOyunu.Properties.Resources;
...
namespace YilanOyunu
{
    public partial class Form1 : MetroForm
    {
        ...
        private void Saha_Paint(object sender, PaintEventArgs e)
        {
            ...
            int boyut = Saha.Width / sutunSayisi;
        ...
        private void skorlarToolStripMenuItem_Click(object sender, EventArgs e)
        {
            new SkorlarForm().ShowDialog();
        ...
        {
            string skorMetin = string.Format("{0:00000};{1};{2}", puan,
                    DateTime.Now.ToString("s"), oyuncu);
